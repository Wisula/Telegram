    ...
    if chat:
        ...
        try:
           ...
           if "Affiliate+" in textmsg:
               ...
               textmsg = textmsg.replace("Affiliate+", "Simuki")
...
AI based chatbot allows Simuki to talk and provides a more interactive group chat experience.
...
Simuki AI chatbot support almost all languages in world .
